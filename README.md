...
- 内置简体中文、English、日本語三套语言资源；可在 GUI 的“语言 / Language / 言語”菜单中即时切换并记住选择，CLI 使用 `--lang zh|en|ja`。界面、进度、警告、错误和生成模型的显示名称使用同一国际化入口，技术 ID 保持稳定。
...
| `--lang` | 系统语言或上次选择 | 显示及诊断语言：`zh`、`en`、`ja` |
