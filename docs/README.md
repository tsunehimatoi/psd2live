...
| [Live2D SDK 配置指南](zh/guide/CUBISM_SDK_SETUP.md) | 为什么要接官方 SDK（一致性而非单纯加速）、非分发原则、本仓库包装源码自建 DLL、着色器部署、状态识别与排障 | 中 · [英](en/guide/CUBISM_SDK_SETUP.md) · [日](ja/guide/CUBISM_SDK_SETUP.md) |
